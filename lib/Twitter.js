...
Twitter.prototype.setBaseUrl = function (url) {
    this.baseUrl = url;
}

Twitter.prototype.getBaseUrl = function () {
    return this.baseUrl;
}

Twitter.prototype.setApiVersion = function (version) {
    this.apiVersion = version;
}

Twitter.prototype.getApiVersion = function () {
    return this.apiVersion;
}

Twitter.prototype.setAccessToken = function (oauth_access_token, oauth_access_token_secret) {
    this.accessToken = oauth_access_token;
    this.accessTokenSecret = oauth_access_token_secret;
}

Twitter.prototype.getAuthenticateUrl = function (oauth) {
    return this.baseUrl + '/oauth/authenticate' + this.buildQS({oauth_token: oauth.token});
}
...
Twitter.prototype.postTweet = function (params, error, success) {
    ...
    var url = this.baseUrl + this.apiVersion + path;
    this.doPost(url, params, error, success);
};
