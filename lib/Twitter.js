...
Twitter.prototype.authenticate = function (oauth, error, success) {
    var url = this.baseUrl + '/oauth/authenticate' + this.buildQS({oauth_token: oauth.token});
...
Twitter.prototype.postTweet = function (params, error, success) {
    ...
    var url = this.baseUrl + this.apiVer + path;
    this.doPost(url, params, error, success);
};
